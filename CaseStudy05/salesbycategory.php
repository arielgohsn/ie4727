  ...
  <body>
    <div id="wrapper">
      ...
      <div id="leftcolumn" style="text-align: center;">
        <h2>Daily <br>Sales <br>Report <br><br>Category</h2>
        <a href="report.html" style="color:#340000">Go Back</a>
      </div>
      <div id="rightcolumn">
        <div class="content">
          <h2 style="margin-left: 8vw;">Sales By Category</h2>
          <div class="boxcontent">
            <table id="reporttab">
              ...
              <tbody>
                ...
                $singleqty = $singlecafeqty + $singlecapqty;
                $singletotal = $singlecafetotal + $singlecaptotal;
                $doubleqty = $doublecafeqty + $doublecapqty;
                $doubletotal = $doublecafetotal + $doublecaptotal;
                ...
                echo "<tr><td>NULL</td><td><p>$$nulltotal</p></td><td>$nullqty</td></tr>";
                echo "<tr><td>Single</td><td><p>$$singletotal</p></td><td>$singleqty</td></tr>";
                echo "<tr><td>Double</td><td><p>$$doubletotal</p></td><td>$doubleqty</td></tr>";
                echo "</tbody></table>";
